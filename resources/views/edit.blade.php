...
@section('content')
    ...
    <form class="col-6 container" name="form" method="POST" enctype="multipart/form-data"
          action="{{ route('developers.update', $getDeveloperByIdForEdit->id ) }}">
        <br>
        @csrf
        @method('PUT')
        <div class="row">
            <div class="form-group col-12">
                ...
                <input type="text" class="form-control" id="name" name="name"
                       value="{{$getDeveloperByIdForEdit->name}}"
            ...
            <div class="form-group col-12">
                ...
                <input type="email" class="form-control" id="email" name="email"
                       value="{{$getDeveloperByIdForEdit->email}}"
            ...
            <div class="form-group col-12">
                ...
                <input type="text" class="form-control" id="phone" name="phone"
                       value="{{$getDeveloperByIdForEdit->phone}}"
            ...
            <div class="form-group col-12">
                ...
                <input type="text" class="form-control" id="location" name="location"
                       value="{{$getDeveloperByIdForEdit->location}}" placeholder="Edit Location">
            </div>
            <div class="form-group col-12">
                <label for="profile_picture" class="form-label">Edit Profile Picture:</label>
                <input type="file" class="form-control" id="profile_picture" name="profile_picture"
                       value="{{$getDeveloperByIdForEdit->profile_picture ?? 0}}"/>
                <img id="profile_picture" src="{{$getDeveloperByIdForEdit->profile_picture}}" width="150px"
                     height="100px"
            ...
            <div class="form-group col-12">
                ...
                <input type="number" class="form-control" id="price_per_hour" name="price_per_hour"
                       value="{{$getDeveloperByIdForEdit->price_per_hour}}" placeholder="Edit Price Per Hour">
            </div>
            <div class="form-group col-12">
                ...
                <select name="technology" class="form-control">
                    <!--                --><?php
                                           ...
                                           if ($data == $getDeveloperByIdForEdit->technology) {
                                               ?>
            ...
            <div class="form-group col-12">
                ...
                <textarea id="article-ckeditor" name="description" class="form-control" rows="10"
                          cols="70">{{$getDeveloperByIdForEdit->description}}</textarea>
            </div>
            <div class="form-group col-12">
                ...
                <input type="text" class="form-control" id="years_of_experience" name="years_of_experience"
                       value="{{$getDeveloperByIdForEdit->years_of_experience}}" placeholder="Edit Years of experience">
            </div>
            <div class="form-group col-12">
                ...
                <select id="inputState" name="native_language" class="form-control">
                    <!--                --><?php
                                           ...
                                           if ($data == $getDeveloperByIdForEdit->native_language) {
                                               ?>
                    <option value="<?php echo $data ?>" selected><?php echo $data ?></option>
                        <?php
                    }else {
            ...
            <div class="form-group col-12">
                ...
                <input type="text" class="form-control" id="linkedin_profile_link" name="linkedin_profile_link"
                       value="{{$getDeveloperByIdForEdit->linkedin_profile_link}}"
                       placeholder="Edit Linkedin Profile Link">
            </div>
